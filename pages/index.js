...
const Home = () => {
  return <div className='bg-primary/60 h-full'>
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
      <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
        ...
        <motion.p variants={fadeIn('down', 0.3)} initial='hidden' animate='show' exit='hidden' className='max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16 '>
          Unleashing the digital realm, one idea at a time!
         From concept to creation, we bring your digital dreams to life.
         Harness the power of innovation, watch your ideas become reality.
        </motion.p>
        {/* btn */}
    ...
    <div className='w-[1200px] h-full absolute right-0 bottom-0'>
      {/* bg image */}
      <motion.div variants={fadeIn('up', 0.5)} initial='hidden' animate='show' exit='hidden' transition={{duration: 1, ease: 'easeInOut'}} className='bg-none xl:bg-explosion xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-0 ' >
          {/* particles */}
          <ParticlesContainer />
          {/* avatar image */}
